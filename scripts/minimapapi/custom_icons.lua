...
MinimapAPI:AddPickup("HorsePillWhiteWhite","HorsePillWhiteWhite",5,70,PillColor.PILL_WHITE_WHITE + PillColor.PILL_GIANT_FLAG,MinimapAPI.PickupNotCollected,"pills",8050)
MinimapAPI:AddPickup("HorsePillReddotsRed","HorsePillReddotsRed",5,70,PillColor.PILL_REDDOTS_RED + PillColor.PILL_GIANT_FLAG,MinimapAPI.PickupNotCollected,"pills",8050)
MinimapAPI:AddPickup("HorsePillPinkRed","HorsePillPinkRed",5,70,PillColor.PILL_PINK_RED + PillColor.PILL_GIANT_FLAG,MinimapAPI.PickupNotCollected,"pills",8050)
MinimapAPI:AddPickup("HorsePillBlueCadetblue","HorsePillBlueCadetblue",5,70,PillColor.PILL_BLUE_CADETBLUE + PillColor.PILL_GIANT_FLAG,MinimapAPI.PickupNotCollected,"pills",8050)
MinimapAPI:AddPickup("HorsePillYellowOrange","HorsePillYellowOrange",5,70,PillColor.PILL_YELLOW_ORANGE + PillColor.PILL_GIANT_FLAG,MinimapAPI.PickupNotCollected,"pills",8050)
MinimapAPI:AddPickup("HorsePillOrangedotsWhite","HorsePillOrangedotsWhite",5,70,PillColor.PILL_ORANGEDOTS_WHITE + PillColor.PILL_GIANT_FLAG,MinimapAPI.PickupNotCollected,"pills",8050)
MinimapAPI:AddPickup("HorsePillWhiteAzure","HorsePillWhiteAzure",5,70,PillColor.PILL_WHITE_AZURE + PillColor.PILL_GIANT_FLAG,MinimapAPI.PickupNotCollected,"pills",8050)
MinimapAPI:AddPickup("HorsePillBlackYellow","HorsePillBlackYellow",5,70,PillColor.PILL_BLACK_YELLOW + PillColor.PILL_GIANT_FLAG,MinimapAPI.PickupNotCollected,"pills",8050)
MinimapAPI:AddPickup("HorsePillWhiteBlack","HorsePillWhiteBlack",5,70,PillColor.PILL_WHITE_BLACK + PillColor.PILL_GIANT_FLAG,MinimapAPI.PickupNotCollected,"pills",8050)
MinimapAPI:AddPickup("PillWhiteYellow","HorsePillWhiteYellow",5,70,PillColor.PILL_WHITE_YELLOW + PillColor.PILL_GIANT_FLAG,MinimapAPI.PickupNotCollected,"pills",8050)
...
MinimapAPI:AddPickup("PillOrangeOrange","PillOrangeOrange",5,70,PillColor.PILL_ORANGE_ORANGE,MinimapAPI.PickupNotCollected,"pills",8001)
MinimapAPI:AddPickup("PillWhiteWhite","PillWhiteWhite",5,70,PillColor.PILL_WHITE_WHITE,MinimapAPI.PickupNotCollected,"pills",8001)
MinimapAPI:AddPickup("PillReddotsRed","PillReddotsRed",5,70,PillColor.PILL_REDDOTS_RED,MinimapAPI.PickupNotCollected,"pills",8001)
MinimapAPI:AddPickup("PillPinkRed","PillPinkRed",5,70,PillColor.PILL_PINK_RED,MinimapAPI.PickupNotCollected,"pills",8001)
MinimapAPI:AddPickup("PillBlueCadetblue","PillBlueCadetblue",5,70,PillColor.PILL_BLUE_CADETBLUE,MinimapAPI.PickupNotCollected,"pills",8001)
MinimapAPI:AddPickup("PillYellowOrange","PillYellowOrange",5,70,PillColor.PILL_YELLOW_ORANGE,MinimapAPI.PickupNotCollected,"pills",8001)
MinimapAPI:AddPickup("PillOrangedotsWhite","PillOrangedotsWhite",5,70,PillColor.PILL_ORANGEDOTS_WHITE,MinimapAPI.PickupNotCollected,"pills",8001)
MinimapAPI:AddPickup("PillWhiteAzure","PillWhiteAzure",5,70,PillColor.PILL_WHITE_AZURE,MinimapAPI.PickupNotCollected,"pills",8001)
MinimapAPI:AddPickup("PillBlackYellow","PillBlackYellow",5,70,PillColor.PILL_BLACK_YELLOW,MinimapAPI.PickupNotCollected,"pills",8001)
MinimapAPI:AddPickup("PillWhiteBlack","PillWhiteBlack",5,70,PillColor.PILL_WHITE_BLACK,MinimapAPI.PickupNotCollected,"pills",8001)
MinimapAPI:AddPickup("PillWhiteYellow","PillWhiteYellow",5,70,PillColor.PILL_WHITE_YELLOW,MinimapAPI.PickupNotCollected,"pills",8001)
...
MinimapAPI:AddPickup("LuckyPenny","LuckyPenny",5,20,5,MinimapAPI.PickupNotCollected,"coins",4070)
